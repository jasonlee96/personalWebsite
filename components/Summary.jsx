...
const summary = [
  { 
    ...
    icon: <FaCode />, 
    size: "col-span-1 row-span-1 md:col-span-2 md:row-span-2 h-100 flex flex-col justify-center items-center bg-[#f3e0c7] shadow-lg rounded-3xl p-6 border border-[#d2b48c] hover:shadow-2xl transition-all" 
  },
  { 
    title: "Specialized in Backend", 
    content: "Been full-stack all the while with expertise in .NET Core.", 
    icon: <FaServer />, 
    size: "col-span-1 row-span-1 md:h-48" 
  },
  { 
